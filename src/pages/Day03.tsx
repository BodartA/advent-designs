  ...
  return (
    <div>
      ...
      <div className=' bg-yellow-200 h-screen pt-12 sm:pt-16'>
        <div className=' h-full lg:p-16 md:p-14 sm:p-12 p-10'>

          <div className='bg-white rounded-3xl h-full lg:min-h-[300px] min-h-[600px] drop-shadow-2xl lg:flex lg:flex-row flex flex-col-reverse'>
